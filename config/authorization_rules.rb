authorization do
  ...
  role :recruiter do
    has_permission_on [:answers, :candidates,
      ...
      :get_questions, :update_status,:send_invitations,:view_package,:by_csv,:add_csv,:csv_import,:ajax_update,:change_subscription,:cancel_subscription,:reactivate_subscription,:trigger_subscription]do
